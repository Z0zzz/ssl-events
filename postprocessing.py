...
class EventData:
    def __init__(
        ...
        self.gp_to_cluster = gp_to_cluster
        self.gp_to_track = gp_to_track
        ...
        this_ev = awkward.Record(
            {
                ...
                "genmet": met_st1[iev],
                "gen_full_track_assoc": gpdata_cleaned.gp_to_track,
                "gen_full_cluster_assoc": gpdata_cleaned.gp_to_cluster
