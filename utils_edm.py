...
def prepare_data_clic(fn):
    ...
    genjets = []
    targetjets = []
    gen_track_assoc_mats = []
    gen_cluster_assoc_mats = []
    ...
    for iev in range(nev):
        ...
        gen_track_assoc_mats.append(gen_track_assoc_mat)
        gen_cluster_assoc_mats.append(gen_cluster_assoc_mat)
        
    return Xs, ytargets, ycands, genmets, genjets, targetjets, gen_track_assoc_mats, gen_cluster_assoc_mats


def generate_examples(files):
    for fi in files:
        Xs, ytargets, ycands, genmets, genjets, targetjets, gen_track_assoc_mats, gen_cluster_assoc_mats = prepare_data_clic(fi)
        for iev in range(len(Xs)):
            ...
            yield str(fi) + "_" + str(iev), {
                ...
                "gen_track_assoc_mats": gen_track_assoc_mats[iev],
                "gen_cluster_assoc_mats": gen_cluster_assoc_mats[iev],
            }